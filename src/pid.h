...
static inline const int32_t clamp(int32_t value, int32_t min, int32_t max) __attribute__((always_inline, unused, hot));
 ...
 */
static const inline int32_t signed_subtract_saturated_32_and_32(const int32_t a, const int32_t b) __attribute__((always_inline, unused, hot));
 ...
 */
static const inline int32_t signed_multiply_accumulate_saturated_32_and_32QN(const int32_t acc, const int32_t a, const int32_t b) __attribute__((always_inline, unused, hot));
